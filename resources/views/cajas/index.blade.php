    ...
    <div class="mb-4 flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-2 sm:space-y-0">
      ...
      <div class="flex space-x-2">
        ...
        <select x-model="filterSucursal"
          ...
          @foreach($cajas->pluck('sucursal')->unique('id')->sortBy('nombre') as $s)
            ...
            @forelse($cajas as $c)
              <tr
                x-show="
                  ...
                  && (!filterSucursal || filterSucursal == '{{ $c->sucursal_id }}')
                "
                class="last:border-0"
              >
                ...
                <td class="px-6 py-4 text-right space-x-2">
                  ...
                  <a href="{{ route('cajas.show', $c) }}"
                    ...
                    {{-- icono similar al de sucursales --}}
