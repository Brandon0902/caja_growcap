<x-app-layout>
  <x-slot name="header">
    <h2 class="font-semibold text-xl text-white leading-tight">
      {{ __('Editar Configuración de Mora') }}
    </h2>
  </x-slot>

  <div class="py-6 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
      <form action="{{ route('config_mora.update', $config_mora) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid gap-6 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              value="{{ old('cargo_fijo', $config_mora->cargo_fijo) }}"
          ...
          <div>
            ...
            <input
              ...
              value="{{ old('porcentaje_mora', $config_mora->porcentaje_mora) }}"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm
                     focus:border-purple-500 focus:ring-purple-500
                     dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
          ...
          <div class="sm:col-span-2">
            ...
            <input
              ...
              value="{{ old('periodo_gracia', $config_mora->periodo_gracia) }}"
              class="mt-1 block w-full rounded-md border-gray-300 shadow-sm
                     focus:border-purple-500 focus:ring-purple-500
                     dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200"
            />
