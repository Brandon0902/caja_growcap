  ...
  <x-slot name="header">
    <div class="flex items-center justify-between gap-3">
      <div class="flex items-center gap-3">
        {{-- ✅ Botón Regresar (mantiene filtros si existían) --}}
        <a href="{{ route('tickets.index', request()->only(['search','estado','prioridad','page'])) }}"
           class="inline-flex items-center px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-md text-sm">
          ← Regresar
        </a>
